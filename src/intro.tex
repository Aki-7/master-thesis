...
\begin{figure}[htbp]
  \begin{minipage}[t]{0.55\linewidth}
    ...
    \subcaption*{Google Earth VR\footnotemark}
  \end{minipage}
  \begin{minipage}[t]{0.43\linewidth}
    \captionsetup[sub]{margin=0.1cm}
    \centering
    \includegraphics[keepaspectratio, height=1.3in]{figures/vrc.png}
    \subcaption*{VRChat\footnotemark}
  \end{minipage}
  \caption{
...
\footnotetext[3]{Adapted from Google. ``Google Earth VR'' \url{https://arvr.google.com/earth/} (accessed on 19 Dec, 2022)}
\footnotetext[4]{Adapted from VRChat Inc. ``PRESS KIT - VRChat'' \url{https://hello.vrchat.com/press} (accessed on 19 Dec, 2022)}
